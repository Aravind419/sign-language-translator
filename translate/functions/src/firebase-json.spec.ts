...
describe('firebase.json', () => {
  ...
  // Prevent mistakes like - https://github.com/your-username/your-repo/commit/ad0ef31a0a2b3cd989dff6a9dcec742157d9619d
  ...
  it('firebase.json should not redirect assets to the index.html', async () => {
    // Fixed in https://github.com/your-username/your-repo/commit/730546444bf1a35c2097230b1562783ae0dfda2a
